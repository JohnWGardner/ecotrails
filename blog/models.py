...
STATUS = ((0, "Draft"), (1, "Published"))  #provides the possible statuses for a blog post: Draft or Published.
...
class BlogPost(models.Model): #from my ERD: Post Table. BlogPost class inherits properties and methods from the models.Model class
    title = models.CharField(max_length=200, unique=True) # sets variable for title
